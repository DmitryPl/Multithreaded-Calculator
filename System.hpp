...
bool DEBUG_SUM = true;
bool DEBUG_SYS = true;
bool DEBUG_FACT = true;
#else
bool DEBUG_SUM = false;
...
class ParseException : public SystemException
{
public:
	ParseException() = delete;
	ParseException(string &&whatStr) noexcept : SystemException(whatStr) {}
	ParseException(const string &whatStr) noexcept : SystemException(whatStr) {}
